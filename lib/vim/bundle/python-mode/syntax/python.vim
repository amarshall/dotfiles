...
function! s:default(name, default) "{{{
  if !exists(a:name)
...
call s:default('g:pymode_syntax_all', 1)

" Highlight 'print' as function
call s:default("g:pymode_syntax_print_as_function", 0)
"
" Highlight 'async/await' keywords
call s:default("g:pymode_syntax_highlight_async_await", g:pymode_syntax_all)

" Highlight '=' operator
call s:default('g:pymode_syntax_highlight_equal_operator', g:pymode_syntax_all)

" Highlight '*' operator
call s:default('g:pymode_syntax_highlight_stars_operator', g:pymode_syntax_all)

" Highlight 'self' keyword
call s:default('g:pymode_syntax_highlight_self', g:pymode_syntax_all)

" Highlight indent's errors
call s:default('g:pymode_syntax_indent_errors', g:pymode_syntax_all)

" Highlight space's errors
call s:default('g:pymode_syntax_space_errors', g:pymode_syntax_all)

" Highlight string formatting
call s:default('g:pymode_syntax_string_formatting', g:pymode_syntax_all)
call s:default('g:pymode_syntax_string_format', g:pymode_syntax_all)
call s:default('g:pymode_syntax_string_templates', g:pymode_syntax_all)
call s:default('g:pymode_syntax_doctests', g:pymode_syntax_all)

" Support docstrings in syntax highlighting
call s:default('g:pymode_syntax_docstrings', 1)

" Highlight builtin objects (True, False, ...)
call s:default('g:pymode_syntax_builtin_objs', g:pymode_syntax_all)

" Highlight builtin types (str, list, ...)
call s:default('g:pymode_syntax_builtin_types', g:pymode_syntax_all)

" Highlight builtin types (div, eval, ...)
call s:default('g:pymode_syntax_builtin_funcs', g:pymode_syntax_all)

" Highlight exceptions (TypeError, ValueError, ...)
call s:default('g:pymode_syntax_highlight_exceptions', g:pymode_syntax_all)

" More slow synchronizing. Disable on the slow machine, but code in docstrings
" could be broken.
call s:default('g:pymode_syntax_slow_sync', 1)
