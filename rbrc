...
ruby_version_detector = Class.new do
  chruby = Module.new do
    define_singleton_method(:match?) { command_exists? 'chruby-exec' }
  ...
  system = Module.new do
    define_singleton_method(:match?) { true }
    define_singleton_method(:name) { nil }
    define_singleton_method(:version) { current_ruby_version }
  end

  version_managers = [chruby, rbenv, rvm, system]
